...
function StickyDiagnosticOverlay({ target, title = "Sticky diagnosis", className = "", onDiagnosis }) {
  ...
  if (!result) return /* @__PURE__ */ jsx("div", { role: "status", "aria-live": "polite", className, children: "Analyzing sticky element\u2026" });
  return /* @__PURE__ */ jsxs("aside", { "aria-label": title, className: `rounded-xl border bg-card p-4 text-card-foreground shadow-lg ${className}`, children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Live check" }),
        /* @__PURE__ */ jsx("h2", { className: "font-semibold", children: title })
      ] }),
      /* @__PURE__ */ jsx("span", { className: `rounded-full px-2.5 py-1 text-xs font-semibold ${result.isSticky ? "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300" : "bg-destructive/15 text-destructive"}`, children: result.isSticky ? "PASS" : "FAIL" })
    ] }),
    result.isSticky ? /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-muted-foreground", children: "No sticky issues detected." }) : /* @__PURE__ */ jsx("ul", { className: "mt-4 flex flex-col gap-2 text-sm text-destructive", children: result.issues.map((issue) => /* @__PURE__ */ jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx("span", { "aria-hidden": "true", children: "\u2022" }),
      /* @__PURE__ */ jsx("span", { children: issue })
    ] }, issue)) }),
    /* @__PURE__ */ jsx("button", { type: "button", onClick: resolve, className: "mt-4 rounded-md border px-3 py-1.5 text-xs font-medium hover:bg-muted", children: "Re-run analysis" })
  ] });
}
export {
